          ...
          <div className="container-all">
            <div className="create-folder-box">
              ...
              <div className="folder-arrov">
                <Link className="text-dark" to="/dash">
                  Folder
                </Link>
                <span> </span>
                <p>
                  {folderPath.map((folder, index) => (
                    <span key={index}>
                      <Link className="text-dark" to={`/fldr/${folder.id}`}>
                        {folder.name}
                      </Link>
        ...
        <center>
          <div>
            <div className="name-funtction">
              <h2 className="text-center text-dark">Create Folder</h2>
              <h2 className="text-center text-dark">Upload File</h2>
            </div>
            <input
              className="inputs"
              type="text"
            ...
            />
            <button className="btn btn-info" onClick={handleCreateFolder}>
              Create Folder
            </button>
            <table
            ...
            <ul className="text-decoration-none">
              {folderFiles.map((file) => (
                <li key={file.id}>
                  <p className="links text-dark d-inline ">{file.name}</p>
                  <button
                    className="btn btn-info text-dark mx-3"
                    onClick={() => {
