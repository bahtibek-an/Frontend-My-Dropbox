            ...
            <div className="d-flex justify-content-between w-100 p-3">
                ...
                <div className="w-50">
                    <div className="d-flex gap-2">
                        <button type="submit" className="btn btn-success" onClick={() => handleFileCreate("newFile.txt")}>Create File</button><br></br>
                        <button type="submit" className="btn btn-success" onClick={() => handleFolderCreate("newFolder")}>Create Folder</button><br></br>
                    </div>
