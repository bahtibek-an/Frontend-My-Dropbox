                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="search-box mb-2 me-2">
                                    <div class="position-relative">
                                        <nav style="color:#4ba2c7;">
                                            <ul class="m-1" style="list-style: none; padding: 0; display: flex">
                                                <li><a href="{{ url('/dashboard') }}" style="margin-right: 2px;">HOME
                                                    </a><span style="margin-right: 5px;">>></span> </li>
                                                @if (isset($folder))
                                                    @foreach ($ancestors as $ancestor)
                                                        <li><a
                                                                href="{{ route('folders.show', ['id' => $ancestor->id]) }}">
                                                                {{ $ancestor->folder_name }} </a> <span
                                        ...
                                        <div class="modal fade" id="uploadFileModal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ route('subfiles.store', ['folder' => $folder->id]) }}"
                                                        ...
                                                        <div class="d-flex mt-3">
                                                            <div class="overflow-hidden me-auto">
                                                                <h5 class="font-size-15 text-truncate mb-1">
                                                                    <a href="{{ route('folders.show', ['id' => $subfolder->id]) }}"
                                                                        class="text-body">{{ $subfolder->folder_name }}</a>
                                                                </h5>
                                                            </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item" target="_blank"
                                                                href="/{{ $subfile->file_path }}">Preview</a>
                                                            <form
                                                                action="{{ route('subfiles.destroy', ['subfile' => $subfile]) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
