        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                   <!-- Navigation -->
                    <nav class="m-1 p-4" style="color:#d63384">
                        ...
                        <div>
                            ...
                            <form action="{{ route('subfolders.store') }}" method="post" class="mb-4">
                                ...
                                <div class="flex">
                                    ...
                                    <button type="submit" class="bg-pink-500 btn text-white px-4 py-2 rounded-r-md">Create</button>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="">
                                ...
                                <form action="{{ route('subfiles.store', ['folder' => $folder->id]) }}" method="post" enctype="multipart/form-data" class="mb-4">
                                    ...
                                    <div class="flex">
                                        ...
                                        <button type="submit" class="bg-pink-500 text-white px-4 py-2 rounded-r-md">Upload</button>
                                    </div>
                                </form>
                            </div>
                    </div>
