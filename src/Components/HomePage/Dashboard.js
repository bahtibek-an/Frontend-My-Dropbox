    ...
    <div id="index-banner" className="parallax-container">
        <div className="section no-pad-bot">
            <div className="container">
                <br/><br/>
                <h1 className="header center teal-text text-lighten-1"><i className="material-icons medium" >whatshot</i>DropBox</h1>
                <div className="row center">
                    ...
                    <h4 className="header col s12 black-text"> Dropbox  est bien plus qu’un espace de stockage sécurisé pour les fichiers. C’est un espace de travail intelligent qui centralise les équipes, les outils et les contenus.</h4>
                </div>
                <div className="row center">
                    <a href='/signup' id="download-button" className="btn-large waves-effect waves-light teal lighten-1">Essayer gratuitement pendant 365 jours</a>
                </div>
                <br/><br/>
    ...
    <div className="row">
      <div className="col s12 m4">
        <div className="icon-block">
          ...
          <p className="light">Créez, stockez et partagez des contenus cloud avec Google Docs, Sheets et Slides, Microsoft Office et DropBox Paper, et regroupez-les avec les fichiers standard de votre DropBox.</p>
        </div>
      </div>
      ...
      <div className="col s12 m4">
        <div className="icon-block">
          ...
          <p className="light">Grâce à notre infrastructure distribuée sécurisée et à nos outils d'administration offrant contrôle et visibilité, les données de votre entreprise sont en sécurité dans DropBox.</p>
        </div>
      </div>
    </div>
 ...
 <div className="container">
    ...
    <div className="row">
      <div className="col s12 m4">
        <div className="icon-block">
          ...
          <p className="light">DropBox Spaces rassemble vos fichiers traditionnels et vos contenus cloud au même endroit. Vos présentations PowerPoint cohabitent ainsi avec vos Google Docs, vos tableaux Trello et tous les autres outils que votre équipe souhaite utiliser.</p>
        </div>
      </div>
      ...
      <div className="col s12 m4">
        <div className="icon-block">
          ...
          <p className="light">Regroupez les fichiers de votre équipe et les conversations correspondantes dans DropBox en connectant des outils tels que Slack et Zoom.</p>
        </div>
      </div>
  ...
  <div className="parallax-container valign-wrapper">
    <div className="section no-pad-bot">
      <div className="container">
        <div className="row center">
          <h5 className="header col s12 black-text">Multipliez les possibilités avec DropBox Business</h5>
        </div>
      </div>
    </div>
  ...
  <footer className="page-footer teal">
    ...
    <div className="footer-copyright">
      ...
      <p className="flow-text right"> DropBox  &copy; 2023 </p>
