      ...
      <div className="d-flex justify-content-between align-items-center">
        <div className="file-icon text-success d-flex justify-content-around align-items-center">
          ...
          <div className="file-name ms-2">
            <a href={file.url} target="_blank" rel="noopener noreferrer" className="text-decoration-none text-success">{file.name}</a>
          </div>
        </div>
        <div className="file-open text-center">
          <a href={file.url} target="_blank" rel="noopener noreferrer" className="text-muted">Open file <span className="ms-2"><ion-icon name="open-outline"></ion-icon></span></a>
        </div>
